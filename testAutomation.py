...
testcases = [
    ...
    pytest.param("http://127.0.0.1:8000/add/-3/3", 0, "Addition of -3 and 3", marks=pytest.mark.edge),
    pytest.param("http://127.0.0.1:8000/multiply/0/5", 0, "Multiplication by zero", marks=pytest.mark.edge),
]
